...
class DiggPaginator(ExPaginator):
    ...
    def page(self, number, *args, **kwargs):
        ...
        # in case you want the pages to count backwards...
        page.page_range_reverse = page.page_range + []
        page.page_range_reverse.reverse()
        page.final_page = page.page_range_reverse[0]
